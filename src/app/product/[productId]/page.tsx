                    ...
                    <div className='w-[100%] h-auto flex md:flex-row flex-col items-start justify-evenly pt-10 dark:text-white'>
                        ...
                        <form className='md:w-[40%] mt-6 p-4 w-full relative h-[100%] flex flex-col items-start justify-start gap-6'>
                            ...
                            <div className='w-full flex flex-col items-center justify-center gap-4'>
                                <Button type='button' className='md:w-[70%] w-[95%] rounded-none text-sm font-bold tracking-wide hover:bg-transparent' onClick={handleBuyNow}>BUY IT NOW<FontAwesomeIcon icon={faShoppingBag} className='ml-2' /></Button>
                                <Button type='button' className='md:w-[70%] w-[95%] rounded-none text-sm font-bold tracking-wide hover:bg-transparent' onClick={(e: Event) => handleAddToCart(e)} disabled={cartLoader}>{cartLoader ? <LightSpinner color='fill-gray-500' /> : <>ADD TO CART<FontAwesomeIcon icon={faCartShopping} className='ml-2' /></>}</Button>
                            </div>
                        </form>
                    </div>
